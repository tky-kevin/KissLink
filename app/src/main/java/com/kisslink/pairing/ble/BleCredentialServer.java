...
public class BleCredentialServer {
    ...
    public BleCredentialServer(@NonNull Context context, @NonNull Callback callback) {
        ...
        this.timeoutRunnable = () -> {
            PairingFlightRecorder.event(TAG, "server timeout: no central connected within window "
    ...
    private final AdvertiseCallback advertiseCallback = new AdvertiseCallback() {
        ...
        @Override public void onStartFailure(int errorCode) {
            PairingFlightRecorder.event(TAG, "advertise FAILED: " + errorCode);
    ...
    private final BluetoothGattServerCallback gattServerCallback = new BluetoothGattServerCallback() {
        ...
        public void onConnectionStateChange(BluetoothDevice device, int status, int newState) {
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                PairingFlightRecorder.event(TAG, "central disconnected (status=" + status + ")");
            }
        }
