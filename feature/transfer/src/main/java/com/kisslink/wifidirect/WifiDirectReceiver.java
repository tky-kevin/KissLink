 ...
 *
 * <p>依賴 {@link WifiDirectEventCallback} 介面而非具體的 {@link WifiDirectManager}，
 * 使此類別在測試中可注入假實作（{@code FakeWifiDirectEventCallback}），
 * 無需啟動真實的 WifiP2pManager。
 *
 * <p>生命週期由 {@link WifiDirectManager#registerReceiver} /
 * {@link WifiDirectManager#unregisterReceiver} 管理；
 * 請在 Activity/Fragment 的 onResume/onPause 中呼叫。
 */
