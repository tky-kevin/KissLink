 ...
 *
 * <p>{@link WifiDirectReceiver} 依賴此介面而非 {@link WifiDirectManager} 具體類別， 使 Receiver
 * 的行為可在測試中透過假實作（Fake）獨立驗證， 無需啟動真實的 WifiP2pManager。
 */
interface WifiDirectEventCallback {
     ...
     *
     * <p>不從廣播 Extra 取 WifiP2pInfo（資料可能過期）， 由 {@link WifiDirectManager} 內部呼叫 {@code
