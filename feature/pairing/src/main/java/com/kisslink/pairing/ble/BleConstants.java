 ...
 * <h3>GATT 服務</h3>
 * <ul>
 *   <li>{@link #CHAR_PEER_TOKEN}:central(reader)把<b>自己的</b> token 寫給 peripheral,
 *       讓雙方都湊齊兩份 token 做 GO 選舉。</li>
 *   <li>{@link #CHAR_CREDENTIAL}:由當選 GO 的一方把 {@code GroupCredential} 交給對方
 *       (GO=peripheral → notify;GO=central → write)。</li>
 * </ul>
 *
 * <p>peripheral(tag)在廣告的 manufacturer data 放入 8-byte nonce;
 * central(reader)以對方 nonce 作 ScanFilter,精準鎖定同一場配對,避免多台混淆。
 */
public final class BleConstants {
    ...
    public static final UUID SERVICE_UUID =
            UUID.fromString("f04b4953-0001-4b9d-9e1a-4b6973734c6b");
