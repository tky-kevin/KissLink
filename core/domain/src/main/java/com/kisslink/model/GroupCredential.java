 ...
 *
 * <p>GO 端建立群組後產生；之後在 M3 由 HCEService 序列化並透過 NFC 傳給 Client 端。
 * Client 端收到後呼叫 {@link com.kisslink.wifidirect.WifiDirectManager#connectAsClient}。
 */
public class GroupCredential {
    ...
    public String toString() {
        return "GroupCredential{ssid='" + ssid
                + "', ip=" + goIpAddress + ":" + transferPort + "}";
    }
}
